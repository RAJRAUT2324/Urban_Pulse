        ...
        <section className="py-32 bg-slate-50 relative overflow-hidden">
            <div className="gov-container">
                ...
                >
                    ...
                    <button className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-white shadow-xl shadow-slate-200/50 text-pmc-blue font-black uppercase text-xs tracking-widest hover:bg-pmc-blue hover:text-white transition-all duration-500 group">
                        Full City Index
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {initiatives.map((item, i) => (
                        <motion.div
                            ...
                            className="group relative h-[450px] rounded-[2.5rem] overflow-hidden cursor-pointer shadow-2xl border border-white/40"
                        >
                            <motion.img
                                src={item.img}
                                alt={item.title}
