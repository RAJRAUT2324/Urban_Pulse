...
const CityPulse = () => {
    ...
    if (hasError) {
        return <div className="p-20 text-center text-red-600 font-bold">Something went wrong. Please check the console.</div>;
    }
    ...
    try {
        ...
        console.error(e);
        return <div className="p-20 text-center text-red-600 font-bold">Error rendering component.</div>;
    }
};
